...
function PlanDetailScreen({ plan, loading, token, onUpdate }) {
  ...
  const saveEdit = async () => {
    ...
    try {
      ...
      if (editForm.tiempoSegundos) {
        payload.tiempoSegundos = toPositiveSeconds(editForm.tiempoSegundos);
      }
      if (editForm.descansoSegundos) {
        payload.descansoSegundos = toPositiveSeconds(editForm.descansoSegundos);
      }
                        ...
                        <div className="plan-day-exercise__edit-form">
                          <div className="plan-day-exercise__form-row">
                            ...
                            <span className="plan-builder-seconds-field">
                              ...
                              {formatSecondsHint(editForm.tiempoSegundos) && (
                                <small className="plan-builder-seconds-hint">{formatSecondsHint(editForm.tiempoSegundos)}</small>
                              )}
                            </span>
                            <span className="plan-builder-seconds-field">
                              <label>
                              ...
                              {formatSecondsHint(editForm.descansoSegundos) && (
                                <small className="plan-builder-seconds-hint">{formatSecondsHint(editForm.descansoSegundos)}</small>
                              )}
                            </span>
                          </div>
                          <div className="plan-day-exercise__form-row">
